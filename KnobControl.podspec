...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "knob control like Slider"
  ...
  spec.author             = { "sachin" => "sachinhunasnale@gmail.com" }
  # Or just: spec.author    = "sachin"
  # spec.authors            = { "sachin" => "sachinhunasnale@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/sachin"
  ...
  spec.source       = { :git => "https://github.com/sachinhunasnale/KnobControl.git" }
